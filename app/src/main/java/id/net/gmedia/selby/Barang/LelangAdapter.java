...
public class LelangAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    LelangAdapter(List<LelangModel> listLelang){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        if(getItemViewType(i) == TYPE_CONTENT){
            return new LelangViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_lelang, viewGroup, false));
        }
        else{
            return new HeaderViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_lelang_header, viewGroup, false));
        }
