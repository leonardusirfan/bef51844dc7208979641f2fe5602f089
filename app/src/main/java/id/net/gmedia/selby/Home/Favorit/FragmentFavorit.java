    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if(v == null || needLoad){
            ...
            if (listItem.size() == 0) {
                ...
                FavoritAdapter adapter = new FavoritAdapter(activity, listItem);
                    ...
                    try{
                        ...
                        if(status == 200 || status == 404){
                            ...
                            for(int i = 0; i < listfavorit.length(); i++){
                                ...
                                listItem.add(new BarangModel(favorit.getString("id_barang"), favorit.getString("barang"), favorit.getString("image"), favorit.getDouble("harga")));
                            }
