...
public class UploadBarangActivity extends AppCompatActivity {
                ...
                public void onSuccess(String result) {
                    try{
                        ...
                        if(status == 200){
                            ...
                            listBrand.add("");
                            for(int i = 0; i < array.length(); i++){
                                listBrand.add(array.getJSONObject(i).getString("brand"));
                            }
                            listBrand.add("Lainnya");

                            ArrayAdapter<String> adapter = new ArrayAdapter<>(
                                    UploadBarangActivity.this, android.R.layout.simple_spinner_item, listBrand);
    ...
    private void initDialog(){
        ...
        btn_reguler = dialog.findViewById(R.id.btn_reguler);
        ...
        btn_lelang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                lbl_harga.setText(R.string.bid_awal);
        ...
        btn_reguler.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                lelang = false;
                dialog.dismiss();
    ...
    private void uploadBarang(){
        try{
            ...
            body.put("foto", uploadAdapter.main_image);
            body.put("gallery", new JSONArray(uploadAdapter.list_image));
            body.put("kondisi", spn_kondisi.getSelectedItemPosition() == 0 ? 1 : 0 );
            body.put("brand", spn_brand.getSelectedItem().toString());
            body.put("kategori", listKategori.get(spn_kategori.getSelectedItemPosition()).getId());

            body.put("lelang", lelang?"1":"0");
            if(lelang){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.action_post:
                ...
                else if(uploadAdapter.main_image.equals("")){
