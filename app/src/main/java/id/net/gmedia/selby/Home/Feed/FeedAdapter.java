...
import id.net.gmedia.selby.Home.Feed.FeedItem.RekomendasiItemModel;
...
public class FeedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        if(viewHolder instanceof TextViewHolder){
            ...
            holder.txt_detail.setText("Menambahkan status baru");
            ...
            Glide.with(context).load(item.getArtis().getImage()).apply(new RequestOptions().circleCrop()).thumbnail(0.5f).into(holder.img_user);
            holder.txt_user.setText(item.getArtis().getNama());
            holder.txt_detail.setText("Menambahkan barang baru");
            holder.txt_tanggal.setText(Converter.DateToString(item.getTimestamp()));
            ...
            holder.btn_lihat_semua.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Gson gson = new Gson();
                    Intent i = new Intent(context, BarangActivity.class);
            ...
            holder.txt_user.setText(item.getArtis().getNama());
            holder.txt_tanggal.setText(Converter.DateToString(item.getTimestamp()));
            holder.txt_detail.setText("Menambahkan foto baru");
            Glide.with(context).load(item.getArtis().getImage()).apply(new RequestOptions().circleCrop()).thumbnail(0.5f).into(holder.img_user);
            ...
            holder.txt_user.setText(item.getArtis().getNama());
            holder.txt_tanggal.setText(Converter.DateToString(item.getTimestamp()));
            holder.txt_detail.setText("Menambahkan 2 foto baru");
            Glide.with(context).load(item.getArtis().getImage()).apply(new RequestOptions().circleCrop()).thumbnail(0.5f).into(holder.img_user);
            ...
            String detail = "Menambahkan " + item.getListGambar().size() + " foto baru";
            ...
            Glide.with(context).load(item.getArtis().getImage()).apply(new RequestOptions().circleCrop()).thumbnail(0.5f).into(holder.img_user);
            holder.txt_user.setText(item.getArtis().getNama());
            holder.txt_detail.setText("Menambahkan barang lelang baru");
            holder.txt_tanggal.setText(Converter.DateToString(item.getTimestamp()));
            ...
            Glide.with(context).load(item.getArtis().getImage()).apply(new RequestOptions().circleCrop()).thumbnail(0.5f).into(holder.img_user);
            holder.txt_user.setText(item.getArtis().getNama());
            holder.txt_detail.setText("Menambahkan kegiatan baru");
            holder.txt_tanggal.setText(Converter.DateToString(item.getTimestamp()));
